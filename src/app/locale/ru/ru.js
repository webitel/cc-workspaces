...
export default {
	...
	header: {
		...
		connectionQuality: {
			...
			medium: 'Может быть задержка, пожалуйста, проверьте сеть.',
			low: 'Качество сети плохое, пожалуйста, проверьте сеть.',
		},
	},
	widgets: {
	...
	transfer: {
		...
		consultTransfer: 'Консультативный перевод',
	},
	contacts: {
	...
	notifications: {
		...
		connectionQuality: {
			low: 'Во время звонка было обнаружено низкое качество сети',
			medium: 'Во время звонка были обнаружены задержки в сети',
		},
	},
	emojiPicker: {
