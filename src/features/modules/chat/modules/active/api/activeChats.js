...
/**
 * Усі id з апішки приводимо до формату sdk одразу тут, щоб далі по коду не
 * думати, який з них з дефісами: sdk шукає чат для ws-екшена по `membersId`,
 * і без нормалізації мемберів жоден екшен по рест чату не знаходить свій чат.
 */
