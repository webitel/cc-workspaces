...
import manual from '../modules/manual/store/manual.js';
import closed from '../modules/closed/store/closed.js';
import chatHistory from '../../../../ui/modules/work-section/modules/chat/modules/chat-messaging/chat-history/store/chat-history.js';
import chatMedia from '../../../../ui/modules/work-section/modules/chat/store/chat-media.js';
...
const getters = {
  ...
  ALL_CHAT_MESSAGES: (state, getters, rootState) => {
    const currentChatMessages = getters.CHAT_ON_WORKSPACE.messages || []; // if chat object did`t have messages
