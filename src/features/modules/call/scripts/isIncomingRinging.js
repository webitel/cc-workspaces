...
const isPreviewDialer = (call) =>
	call.queue && call.queue.queue_type === QueueTypeName.PREVIEW_DIALER;
...
const isInboundRinging = (call) => call.direction === CallDirection.Inbound;

const isNotManualCall = (call) => !call.queue?.manual_distribution;
