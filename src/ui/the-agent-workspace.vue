...
import appNotificationMixin from '../features/modules/notifications/mixins/appNotificationMixin.js';
import panelSizeControllerMixin from './mixins/panelSizeControllerMixin.js';
import CcHeader from './modules/app-header/app-header.vue';
import InfoSection from './modules/info-section/the-agent-info-section.vue';
import DisconnectPopup from './modules/popups/disconnect-popup/disconnect-popup.vue';
...
import WidgetBar from './modules/widget-bar/widget-bar.vue';
