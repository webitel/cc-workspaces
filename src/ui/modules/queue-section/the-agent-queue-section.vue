...
import CallQueue from './modules/call-queue/the-agent-call-queue.vue';
import ChatQueue from './modules/chat-queue/the-agent-chat-queue.vue';
import JobQueue from './modules/job-queue/the-agent-job-queue.vue';
