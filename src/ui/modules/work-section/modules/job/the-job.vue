...
import JobHeader from './modules/job-header/job-header.vue';
import JobFooter from './modules/job-footer/job-footer.vue';
import JobVariablesContainer from './components/job-variables-container.vue';
