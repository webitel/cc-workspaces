...
import Transfer from '../call-transfer/_shared/components/call-transfer-container.vue';
...
describe('call on call component', () => {
	it('Draws Active component when ringing event fires', async () => {
		...
		expect(wrapper.findComponent(CallPreview).exists()).toBeTruthy();
	});

	it(
		'Draws Preview component when Outbound Call ' +
			'from preview dialer is set',
		async () => {
			const call = {
...
describe('Make new call functionality', () => {
	it('Draws a numpad on open', async () => {
		...
		expect(numpad.isVisible()).toBeTruthy();
	});
});
...
describe('Transfer functionality', () => {
	it('Opens transfer tab on event emit', async () => {
		...
		expect(wrapper.findComponent(Transfer).exists()).toBeTruthy();
	});
...
describe('Bridge functionality', () => {
	it('Opens bridge tab on event emit', async () => {
		...
		expect(wrapper.findComponent(Bridge).exists()).toBeTruthy();
	});
});
