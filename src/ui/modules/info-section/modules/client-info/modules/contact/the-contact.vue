...
import ContactMode from './enums/ContactMode.enum.js';
import AddContact from './components/views/add-contact.vue';
import SearchContact from './components/views/search-contact.vue';
import ViewContact from './components/views/view-contact.vue';
