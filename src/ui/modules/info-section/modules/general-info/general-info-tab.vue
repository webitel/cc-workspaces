...
import AgentScore from './components/agent-score.vue';
import AgentOrgStructure from './components/agent-org-structure.vue';
import AgentPauseCauses from './components/agent-pause-causes.vue';
import AgentQueues from './components/agent-queues.vue';
