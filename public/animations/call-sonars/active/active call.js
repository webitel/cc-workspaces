...
lib.ssMetadata = [
		{name:"active call_atlas_", frames: [[42,188,28,28],[0,188,40,39],[90,177,52,51],[102,0,64,63],[0,0,100,98],[0,100,88,86],[90,100,76,75]]}
];
...
(lib.CachedTexturedBitmap_1 = function() {
	this.initialize(ss["active call_atlas_"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.activecall = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(9).to({startPosition:0},0).to({alpha:0.6992},10).wait(100).to({startPosition:0},0).to({alpha:1},10).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(9).to({alpha:1},10).to({alpha:0.6016},10).wait(80).to({alpha:1},10).to({alpha:0.6016},10).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(19).to({alpha:1},10).to({alpha:0.5},10).wait(60).to({alpha:1},10).to({alpha:0.5},10).wait(11));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(29).to({alpha:1},10).to({alpha:0.3984},10).wait(40).to({alpha:1},10).to({alpha:0.3984},10).wait(21));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(39).to({alpha:1},10).to({alpha:0.3008},10).wait(20).to({alpha:1},10).to({alpha:0.3008},10).wait(31));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(49).to({alpha:1},10).to({alpha:0.1992},10).to({alpha:1},10).to({alpha:0.1992},10).wait(41));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(59).to({alpha:1},10).to({alpha:0.1016},10).wait(51));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/active call_atlas_.png", id:"active call_atlas_"}
	],
	preloads: []
};
