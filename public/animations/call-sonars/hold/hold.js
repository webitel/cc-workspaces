...
lib.ssMetadata = [
		{name:"hold_atlas_", frames: [[42,188,28,28],[0,188,40,39],[90,177,52,51],[102,0,64,63],[0,0,100,98],[0,100,88,86],[90,100,76,75]]}
];
...
(lib.CachedTexturedBitmap_1 = function() {
	this.initialize(ss["hold_atlas_"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.hold = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/hold_atlas_.png", id:"hold_atlas_"}
	],
	preloads: []
};
